...
class RequestPendingPage extends GetWidget<MyRequestController> {
  const RequestPendingPage({Key? key}) : super(key: key);
  @override
      ...
      body: Container(
        ...
        child: ListView.builder(
          ...
          itemBuilder: (context, element) {
            return InkWell(
                onTap: () {
                  Get.to(() => const PendingDetailView(screenName: 'Pending',));
                },
